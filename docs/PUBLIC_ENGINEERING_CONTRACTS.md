...
3. Body-born meaning is not a claim of biological life or subjective experience.
4. A public event reading is not the private mechanism.
5. A response direction is not final speech.
6. Diagnostic or public summary material is not memory.
7. Memory or residue must not become a motor.
8. A reaction, tail, warning, or diagnostic summary is not memory or lived residue.
9. Any future residue-like claim must require recovery evidence, provenance, and separate review.
10. Body-contour distinction is an achievement, not command authority.
11. A Body Shadow check may show distinction without creating behavior, memory, truth, speech authority, or implementation permission.
